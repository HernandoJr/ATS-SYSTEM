...
if (isset($_POST['search'])) {
    ...
    $query = "SELECT * FROM teachers WHERE firstname LIKE '%$search_term%' OR lastname LIKE '%$search_term%' OR teacher_id like '%$search_term%'";
        ...
        <h1 style="  text-shadow: 3px 2px 3px rgba(0, .5, 0, .80)" class="fw-bolder text-center text-warning mt-3 text-outline">TEACHER LIST</H1>
            ...
            <form method="POST">
                <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control rounded" placeholder="Search by firstname or lastname or id"
                        name="search">
