...
<div class="container">
    ...
    <form method="post">
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="teacher" name="teacher" value="<?php echo $row['teacher']; ?>">
        </div>
        <div class="form-group">
            <label for="subject_description">Subject Description:</label>
            <input type="text" class="form-control" id="subject_description" name="subject_description" value="<?php echo $row['subject_description']; ?>">
        </div>
        <div class="form-group">
