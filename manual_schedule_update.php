...
if ($result->num_rows > 0) {
    ...
    $stmt = $conn->prepare("UPDATE manual_generated_schedule SET teacher=?, subject_description=?, subject_code=?, subject_hours=?, subject_type=?, subject_units=?, course_name=?, section_name=?, section_year=? WHERE id=?");
